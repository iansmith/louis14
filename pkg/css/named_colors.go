...
// named_colors.go — CSS Color 4 §6.1 named colors.
//
// The canonical 148-entry CSS keyword color table (147 distinct sRGB values
// plus the deprecated "grey" spellings that alias "gray", "darkgrey", etc.).
// Includes "rebeccapurple" added by CSS Color Module Level 4.
//
...
// namedColors is the lookup table for CSS named color keywords. Keys are
// lower-case; ParseColor lowercases its input before lookup.
