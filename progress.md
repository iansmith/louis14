...
| Question | Answer |
|----------|--------|
| Where am I? | **css-multicol Phase 12c landed 2026-04-23** (commits `cccbd05e` + `b0825367` + `32665350`). css-multicol at **130/458** (up from 94 baseline; 12a +1, 12b +13, 12c +22). css-position at 91/104 (baseline corrected from stale 95/100). Gates all green: wm 781/781, CSS2 99/99, flex 626/629. Driver `multicol-nested-010.html` 6000 → 3500 px; residual is paint/leaf-fragmentation, out-of-phase. |
| Where am I going? | css-multicol 94 → ~300+ via Phase 12a–12h. Currently at 130/458 after 12c. Invariants must hold: wm 781/781, CSS2 99/99, flex ≥626, css-position ≥91/104, css-transforms ≥172. Next: 12d (forced breaks, `break-before/after:column` + `break-inside:avoid-column`, cla.cc `BreakToken` + `BreakAppeal`); or paint/leaf-fragmentation follow-up to close driver-010's 3500-px residual. |
