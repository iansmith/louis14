...
| Question | Answer |
|----------|--------|
| Where am I? | css-position category, **85/100 runnable PASS**. Phase 1 (G-TABLE-REL) DONE; Phase 2 dissolved; Phase 3 (G-DYN-STATIC) DONE; Phase 4 (G-ABS-CENTER + G-HYPO, IMCB) DONE. **Phase 5: G-FIXED Part A + G-ROOT-FLEX-GRID DONE (M5a, M5b).** **Phase 6: G-ABS-IN-INLINE DONE (M6).** **Phase 7: G-STICKY DONE (commit `05aff97e`).** **Phase 8: G-REPLACED DONE (2026-04-21, commit `0e1fde9f`).** Next: Phase 9 (G-SINGLETONS, 11 tests) or G-SCROLL residuals. Phase 5 G-FIXED Part B (paint-clip/scrollTop) still pending; overlaps G-SCROLL. |
