...
**Phase 13a landed 2026-04-25.** New `pkg/geometry/layoutunit` package — Blink-parity `LayoutUnit{raw int32}` foundational types with 16 unit tests, all six gate invariants held. No callers yet; 13b introduces composite geometry types. See "Phase 13 sub-phases" table and `progress.md` "Phase 13a: foundational LayoutUnit types" for the landing details.
