...
**Phases 13a + 13b + 13c landed 2026-04-25.** Foundational LayoutUnit scalar (`pkg/geometry/layoutunit`, 13a) and composite geometry types + WM conversions (`pkg/geometry`, 13b) earlier today; **all `PhysicalFragment` coordinate fields migrated to the new types in 13c** via three small checkpoint commits (13c.1 RelativeOffset `6e689d8e`, 13c.2 Children[].Offset `4dc4ac0b`, 13c.3 Size `912c03fa`). Every commit gate-swept; all six invariants held at every checkpoint (CSS2 99/99, flex 626/629, position 92/104, wm 781/781, multicol 179/455, spanner-frag 12/13). 13d (ConstraintSpace + LayoutResult) is next. See "Phase 13 sub-phases" table and `progress.md` "Phase 13a/13b/13c" sections for landing details.
...
## Phase 13: LayoutUnit precision discipline (13a + 13b + 13c LANDED, 2026-04-25)
