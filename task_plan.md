...
**Phase 12 (css-multicol)** remains the active layout-feature track at 179/455. Most active follow-up targets done: F1 (wm 781/781), F5 (multicol +3 list-item tests), HTML tokenizer EOF-recovery (css-position 91/104). F2/F3/F4 remain PARTIAL with documented residuals. **Phase 13 (LayoutUnit precision discipline) CLOSED 2026-04-26:** 13a + 13b + 13c + 13d + 13e (13e.1–13e.6) + 13e′ (13e′.1–13e′.3) + 13f (13f.1–13f.3, 13f.4 skip) + 13g.1–13g.4 + 13h all DONE. Follow-ups: clear-001 (float-paint `ToEnclosingRect` discipline), `drawColumnRules` content-area origin (render.go:2931-2933), consumer-accumulator promotion sweep.
